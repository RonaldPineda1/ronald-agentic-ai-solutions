...
python week3_mcp_intro/mcp_weather_tool.py --serve-api

# 4. Launch agent runner (registers tool schema)
python week3_mcp_intro/mcp_agent_runner.py --query "What is the weather in Madrid?"
...
_End of Week 3 Lab Instructions_
